      ...
      >
        ...
        />
          ...
          <nav className='flex flex-row  h-1/6 z-10  w-full '>
              ...
              <Link smooth to='#about-us' className='font-bold ml-auto hover:text-soldierGreen'>About Us</Link>
              <Link smooth to='#services' className='font-bold ml-5 mr-4 hover:text-soldierGreen'>Services</Link>
          </nav>
          <div className='flex flex-row relative pl-20'>
            <div className='flex flex-col w-1/4 text-center mt-40 ml-40 justify-center z-10'>
              <p className='text-2xl font-bold text-ceylaniteGreen text-left '>
                Bringing Farmers From 
                All Around The World,
                Together      
              </p>
              <button className='font-bold text-mustardGreen rounded-3xl p-4 w-1/2 bg-ceylaniteGreen mt-10 hover:bg-willowGreen hover:border-2 hover:border-ceylaniteGreen hover:text-ceylaniteGreen mx-auto shadow-md'>Start Now</button>      
            </div>
            <div className='rounded-full size-72  overflow-hidden absolute right-0 top-1/4 mt-4 shadow-md'>
              <img src={Plant} alt='plant' className='w-full h-full object-cover'/>
            </div>
        </div>
      </div>
